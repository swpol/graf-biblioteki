...
import { Component as s2, options as l2, createElement as h2, Fragment as y4, toChildArray as f3, createContext as oe } from "preact";
import { useContext as ue, useState as F5, useEffect as m3, useRef as T4, useCallback as ie } from "preact/hooks";
...
l2.unmount = function(e) {
...
}, (b3.prototype = new s2()).__c = function(e, n) {
  var t2 = n.__c, r = this;
  ...
  var o = n.__a && h2(y4, null, e.fallback);
  return o && (o.__u &= -33), [h2(y4, null, n.__a ? null : e.children), o];
};
...
(v5.prototype = new s2()).__a = function(e) {
...
l2.vnode = function(e) {
  typeof e.type == "string" && function(n) {
    ...
    r == "select" && o.multiple && Array.isArray(o.value) && (o.value = f3(t2.children).forEach(function(c) {
      c.props.selected = o.value.indexOf(c.props.value) != -1;
    })), r == "select" && o.defaultValue != null && (o.value = f3(t2.children).forEach(function(c) {
...
(d2.prototype = new s2()).__a = function(e) {
