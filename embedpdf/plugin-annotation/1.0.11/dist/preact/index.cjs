...
function AnnotationContainer({
  ...
  const [dragState, setDragState] = (0, import_hooks3.useState)("idle");
  const [resizeDirection, setResizeDirection] = (0, import_hooks3.useState)(null);
  const [startPos, setStartPos] = (0, import_hooks3.useState)(null);
  const [startRect, setStartRect] = (0, import_hooks3.useState)(null);
  const [currentRect, setCurrentRect] = (0, import_hooks3.useState)(trackedAnnotation.object.rect);
  const [previewObject, setPreviewObject] = (0, import_hooks3.useState)(null);
...
function Highlight({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: rects.map((b4, i2) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "div",
    {
      onMouseDown: onClick,
      style: {
...
function Underline({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: rects.map((r, i2) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "div",
    {
      onMouseDown: onClick,
      style: {
...
function Strikeout({
  ...
  const thickness = 2 * scale;
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: rects.map((r, i2) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "div",
    {
      onMouseDown: onClick,
      style: {
...
function Squiggly({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: rects.map((r, i2) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
    "div",
    {
      onMouseDown: onClick,
      style: {
...
function Ink({
  ...
  const paths = (0, import_hooks5.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
    "svg",
    {
      ...
      children: paths.map((d2, i2) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        "path",
        {
          d: d2,
          fill: "none",
...
// ../plugin-selection/dist/preact/index.js
var G5 = (0, import_preact7.createContext)({
  registry: null,
  isInitializing: true,
  pluginsReady: false
});
function H5() {
  const e = (0, import_hooks6.useContext)(G5);
  if (e === void 0)
    throw new Error("useCapability must be used within a PDFContext.Provider");
...
var x6 = () => T4(z5.id);
var I4 = (0, import_preact7.createContext)({
  registry: null,
  isInitializing: true,
  pluginsReady: false
});
...
function Annotations(annotationsProps) {
  ...
  const [annotations, setAnnotations2] = (0, import_hooks8.useState)([]);
  const { register } = q({ pageIndex });
  const [selectionState, setSelectionState] = (0, import_hooks8.useState)(null);
  ...
  const handleClick = (0, import_hooks8.useCallback)(
    (e, annotation) => {
      e.stopPropagation();
...
function TextMarkup({ pageIndex, scale }) {
  const { provides: selectionProvides } = x6();
  const { provides: annotationProvides } = useAnnotationCapability();
  const [rects, setRects] = (0, import_hooks9.useState)([]);
  const [boundingRect, setBoundingRect] = (0, import_hooks9.useState)(null);
  const [activeTool, setActiveTool] = (0, import_hooks9.useState)({ variantKey: null, defaults: null });
...
var InkPaint = ({ pageIndex, scale, pageWidth, pageHeight }) => {
  const { provides: annotationProvides } = useAnnotationCapability();
  const [activeTool, setActiveTool] = (0, import_hooks11.useState)({ variantKey: null, defaults: null });
  ...
  const [currentStrokes, setCurrentStrokes] = (0, import_hooks11.useState)([]);
  const [isDrawing, setIsDrawing] = (0, import_hooks11.useState)(false);
  const timerRef = (0, import_hooks11.useRef)(null);
  const pageWidthPDF = pageWidth / scale;
  const pageHeightPDF = pageHeight / scale;
  const handlers = (0, import_hooks11.useMemo)(
    () => ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
    "svg",
    {
      ...
      height: dh * scale,
      viewBox: `0 0 ${dw} ${dh}`,
      children: paths.map((d2, i2) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        "path",
        {
          d: d2,
          fill: "none",
