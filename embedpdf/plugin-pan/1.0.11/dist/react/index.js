...
s.vnode = function(e) {
  typeof e.type == "string" && function(r) {
    ...
    o == "select" && n.multiple && Array.isArray(n.value) && (n.value = g(t2.children).forEach(function(_5) {
      _5.props.selected = n.value.indexOf(_5.props.value) != -1;
    })), o == "select" && n.defaultValue != null && (n.value = g(t2.children).forEach(function(_5) {
...
import { useContext as ue, useState as F4, useEffect as m3, useRef as T3, useCallback as ie } from "preact/hooks";
...
}, (P4.prototype = new s2()).__c = function(e, n) {
  var t2 = n.__c, r = this;
  r.o == null && (r.o = []), r.o.push(t2);
...
import { Component as s3, options as a2, createElement as d2, Fragment as h3, toChildArray as f4, createContext as q4 } from "preact";
import { useContext as G5, useRef as I5, useLayoutEffect as Z2, useState as J3, useEffect as K3 } from "preact/hooks";

// ../plugin-viewport/dist/jsxRuntime.module-D89ud_rY.js
import { options as l3 } from "preact";
...
(b4.prototype = new s3()).isPureReactComponent = true, b4.prototype.shouldComponentUpdate = function(e, r) {
...
a2.unmount = function(e) {
  var r = e.__c;
  r && r.__R && r.__R(), r && 32 & e.__u && (e.type = null), P7 && P7(e);
}, (m5.prototype = new s3()).__c = function(e, r) {
  var t2 = r.__c, n = this;
  ...
  var o = r.__a && d2(h3, null, e.fallback);
  return o && (o.__u &= -33), [d2(h3, null, r.__a ? null : e.children), o];
};
...
(p5.prototype = new s3()).__a = function(e) {
...
s3.prototype.isReactComponent = {}, ["componentWillMount", "componentWillReceiveProps", "componentWillUpdate"].forEach(function(e) {
  Object.defineProperty(s3.prototype, e, { configurable: true, get: function() {
    return this["UNSAFE_" + e];
  }, set: function(r) {
    Object.defineProperty(this, e, { configurable: true, writable: true, value: r });
  } });
...
a2.vnode = function(e) {
  typeof e.type == "string" && function(r) {
    ...
    n == "select" && o.multiple && Array.isArray(o.value) && (o.value = f4(t2.children).forEach(function(c) {
      c.props.selected = o.value.indexOf(c.props.value) != -1;
    })), n == "select" && o.defaultValue != null && (o.value = f4(t2.children).forEach(function(c) {
      c.props.selected = o.multiple ? o.defaultValue.indexOf(c.props.value) != -1 : o.defaultValue == c.props.value;
...
(x5.prototype = new s3()).isPureReactComponent = true, x5.prototype.shouldComponentUpdate = function(e, r) {
...
}, (y5.prototype = new s3()).__c = function(e, r) {
  var t2 = r.__c, n = this;
  n.o == null && (n.o = []), n.o.push(t2);
...
(v6.prototype = new s3()).__a = function(e) {
